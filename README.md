...
R package **mrfaocore**, version **1.9.1**
...
Chen D, Kreidenweis U, Mishra A, Karstens K, Bodirsky B, Leip D, Stevanovic M, Leon Bodrisky B, Klein D, Molina Bacca E (2026). "mrfaocore: madrat-based package providing core FAO-related preprocessing functions." Version: 1.9.1, <https://github.com/pik-piam/mrfaocore>.
